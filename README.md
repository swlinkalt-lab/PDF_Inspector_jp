...
契約書・仕様書・報告書など、  
**数十〜数百件のPDFを1件ずつ開いて確認していませんか？**

PDF Inspector Businessは、  
指定したキーワードを含むPDFだけをまとめて抽出し、  
**目視確認が必要な対象を一気に絞り込むための業務用ツール**です。
...
- 「この単語が入ってる資料だけ確認したい」ができない
- 確認作業に時間を取られ、**判断・対応が後ろ倒しになる**  

<!-- デモGIF -->
![PDF Inspector Demo](./assets/businessPIC_JP6.png)

> 「今から200ものPDFを確認しなきゃ…」  
> 「でも数分で確認すべき書類10件だけに絞り込めた！」
---
